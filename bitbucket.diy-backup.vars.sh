...
: ${BITBUCKET_BACKUP_BASE:=/app/atlassian/bitbucket/backup}
...
BITBUCKET_BACKUP_ROOT=${BITBUCKET_BACKUP_BASE}/tmp
...
BITBUCKET_BACKUP_ARCHIVE_ROOT=${BITBUCKET_BACKUP_BASE}/archives
